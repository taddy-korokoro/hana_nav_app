class Scraping < ApplicationRecord
  ...
  def self.spot_scrape
    ...
    doc.css('#flower option').each {|flower|
      select_url_1 = "?utf8=✓&searching=1&latitude=&longitude=&time=&flower="
      select_url_2 = "&area=&keyword=&button="
      html = URI.encode.open(base_url + feature_url + select_url_1 + flower['value'] + select_url_2).read
      doc = Nokogiri::HTML.parse(html)
