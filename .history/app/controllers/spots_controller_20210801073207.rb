class SpotsController < ApplicationController
  ...
  before_action :set_spot, only: %i[edit show update destroy placards photos map]
  before_action :set_travel_record, only: %i[photos placards map]
