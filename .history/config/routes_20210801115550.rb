Rails.application.routes.draw do
  ...
  post 'travel_records', to: 'travel_records#header_create', as: :header_travel_records
  get 'travel_records/header_new', to: 'travel_records#header_new', as: :header_new_travel_records
  resources :users
  resources :spots do
    member do
      get 'placards'
